...
namespace module_file
{
	...
	{
		TOKEN_KIND_MASK   = 0xff000000u,
		TOKEN_INDEX_MASK  = 0x00ffffffu,
		TOKEN_CONSTANTDEF = 0x02000000u,
		TOKEN_FUNCTIONDEF = 0x04000000u,
		TOKEN_TYPEDEF     = 0x10000000u,
		TOKEN_FIELDDEF    = 0x12000000u,
		TOKEN_METHODDEF   = 0x14000000u,
		TOKEN_STRING      = 0x20000000u,
		TOKEN_MODULEREF   = 0x40000000u,
		TOKEN_FUNCTIONREF = 0x44000000u,
		TOKEN_TYPEREF     = 0x50000000u,
		TOKEN_FIELDREF    = 0x52000000u,
		TOKEN_METHODREF   = 0x54000000u,
	};

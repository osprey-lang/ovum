...
namespace os
{
	...
	//   A status code which indicates whether an error occurred. If
	//   the file was opened successfully, FILE_OK is returned.
	FileStatus CloseMemoryMappedFile(MemoryMappedFile *file);
	...
	void *MapView(MemoryMappedFile *file, MmfViewAccess access, int64_t offset, size_t size);
